   ...
   <div style={{backgroundImage: `url(${image})`}}>
    <div className="contactdiv">
      ...
      <div className="contactinfodiv">
        <h2>Contact Us</h2>
        <p> Kraft.co Clothes and Formal Wear company was developed in 2021 by Front End Developer M. Batuhan Yılmaz and Ogün Demirkıran with their contributions Kodluyoruz and Patika.dev , using React Js. ☺ </p>
